...
export const siteConfig: SiteConfig = {
  ...
  banner: {
    ...
    credit: {
      ...
      text: 'HAPPY NEW YEAR 2025! by 红油奇亚籽',              // Credit text to be displayed
      url: 'https://www.pixiv.net/artworks/125770047'                // (Optional) URL link to the original artwork or artist's page
    }
  },
  toc: {
