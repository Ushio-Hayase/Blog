...
$$\begin{align} v(s)\\= \it E[G_t|S_t=s] \\ = E[R_{t+1}+\gamma R_{t+2}+\gamma^2R_{t+3}+...|S_t=s] \\ = E[R_{t+1}+\gamma(R_{t+2}+\gamma R_{t+3}+...)|S_t=s] \\ = E[R_{t+1}+\gamma G_{t+1}|S_t=s] \\ = E[R_{t+1}+\gamma v(S_{t+1})|S_t=s] \end{align} $$
